    ...
    const methods = {
        getAvailableMoves: (currentPosition: Position): Position[] => {
            ...
            let availablePositionsToMove: Position[] = [
                {file: currentPosition.file + 1 as unknown as File, rank: currentPosition.rank + 2 as unknown as Rank},
                {file: currentPosition.file + 1 as unknown as File, rank: currentPosition.rank - 2 as unknown as Rank},
                {file: currentPosition.file - 1 as unknown as File, rank: currentPosition.rank + 2 as unknown as Rank},
                {file: currentPosition.file - 1 as unknown as File, rank: currentPosition.rank - 2 as unknown as Rank},
                {file: currentPosition.file + 2 as unknown as File, rank: currentPosition.rank + 1 as unknown as Rank},
                {file: currentPosition.file + 2 as unknown as File, rank: currentPosition.rank - 1 as unknown as Rank},
                {file: currentPosition.file - 2 as unknown as File, rank: currentPosition.rank + 1 as unknown as Rank},
                {file: currentPosition.file - 2 as unknown as File, rank: currentPosition.rank - 1 as unknown as Rank},
            ]
...
<BasePiece name="knight" {piece} {methods} />
